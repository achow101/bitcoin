...
util::Expected<void, wallet::WalletError> WalletModel::setWalletLocked(bool locked, const SecureString &passPhrase)
{
    if(locked)
    {
        // Lock
        ...
        return util::Unexpected{wallet::WalletError{wallet::WalletErrorCode::GenericError, Untranslated(tr("Error: Unable to lock the wallet").toStdString())}};
    }
    else
    {
        // Unlock
