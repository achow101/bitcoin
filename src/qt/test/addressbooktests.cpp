...
void TestAddAddressesToSendBook(interfaces::Node& node)
{
    ...
    {
        LOCK(wallet->cs_wallet);
        wallet->SetAddressBook(r_key_dest, r_label.toStdString(), interfaces::Wallet::AddressPurpose::RECEIVE);
        wallet->SetAddressBook(s_key_dest, s_label.toStdString(), interfaces::Wallet::AddressPurpose::SEND);
    }
