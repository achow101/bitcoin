 ...
 */
util::Result<CreatedTransactionResult> CreateTransaction(CWallet& wallet,        WalletUnlockReserver& reserver, const std::vector<CRecipient>& vecSend, std::optional<unsigned int> change_pos, const CCoinControl& coin_control, bool sign = true);
