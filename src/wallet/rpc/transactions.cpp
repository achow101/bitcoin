...
static UniValue ListReceived(const CWallet& wallet, const UniValue& params, const bool by_label, const bool include_immature_coinbase) EXCLUSIVE_LOCKS_REQUIRED(wallet.cs_wallet)
{
    ...
    const auto& func = [&](const CTxDestination& address, const std::string& label, const interfaces::Wallet::AddressPurpose purpose, bool is_change) {
    ...
    if (filtered_address) {
        ...
        if (entry) func(*filtered_address, entry->GetLabel(), entry->GetPurpose(), /*is_change=*/false);
    } else {
