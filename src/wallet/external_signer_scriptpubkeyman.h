...
public:
    ...
    static std::unique_ptr<ExternalSignerScriptPubKeyMan> CreateNew(WalletStorage& storage, WalletBatch& batch, WalletUnlockReserver& reserver, int64_t keypool_size, std::unique_ptr<Descriptor> desc);
